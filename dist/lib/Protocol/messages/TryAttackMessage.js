...
var TryAttackMessage = /** @class */ (function (_super) {
    __extends(TryAttackMessage, _super);
    function TryAttackMessage() {
    ...
    return TryAttackMessage;
}(protobufjs_1.Message));
exports.default = TryAttackMessage;
